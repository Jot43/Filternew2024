...
auth_channel = environ.get('AUTH_CHANNEL','-1001990125778')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+PNudFBXDIrFmOTg1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Goldmines_Officialy')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/8')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+FlyGqwq3U1dlODk1')
